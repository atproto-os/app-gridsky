...
const APP_ID = 'org.owdproject.gridsky'
const WINDOW_MODEL = 'main'

export default defineNuxtPlugin({
  name: 'app-gridsky-playground-launch',
  dependsOn: ['desktop-app-gridsky-register'],
  async setup(nuxtApp) {
    ...
    async function surfaceWindow() {
      ...
      await applicationManager.execAppCommand(APP_ID, 'gridsky --new --no-check')
